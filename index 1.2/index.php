...
<title>Pestaña</title>
<body>
<h1 style="color:#4682B4;">Inserte los datos para cotizar</h1>
...
if(isset($_POST['i_btn_calcular'])){
	...
	mysqli_query($conexion,"insert into testdb(apellido,nombre,correo) values 
                       ('$_REQUEST[i_apellido]','$_REQUEST[i_name]','$_REQUEST[i_correo]')")
...
<!--	cs consulta,md modify,in incluir
<table> 
  <tr>
     <td>Id</td> 
     <td>Apellido</td> 
